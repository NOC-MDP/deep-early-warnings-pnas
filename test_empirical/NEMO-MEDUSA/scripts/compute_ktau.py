...
def compute_ktau(parameter:str,region:str):
    ...
    # Export dataframe
    df_ktau_forced.to_csv(f"{region}/results/{parameter}/ews/df_ktau_forced.csv")
    ...
    # Export dataframe
    df_ktau_null.to_csv(f"{region}/results/{parameter}/ews/df_ktau_null.csv")

if __name__ == "__main__":
    compute_ktau(parameter="CHL",region="Labrador_Sea")
