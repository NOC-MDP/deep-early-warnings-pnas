...
def compute_ews(parameter:str, region:str):
    os.makedirs(f"{region}/results/{parameter}/ews", exist_ok=True)
    os.makedirs(f"{region}/results/{parameter}/resids", exist_ok=True)
    ...
    # # Export
    df_ews.to_csv(f"{region}/results/{parameter}/ews/df_ews_forced.csv")

if __name__ == "__main__":
    compute_ews(parameter="CHL",region="Labrador_Sea")
